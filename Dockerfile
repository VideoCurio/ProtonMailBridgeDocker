...
ENV PROTON_BRIDGE_ENABLE_SMTP_FORWARD=${PROTON_BRIDGE_ENABLE_SMTP_FORWARD:-yes}
ENV PROTON_BRIDGE_ENABLE_IMAP_FORWARD=${PROTON_BRIDGE_ENABLE_IMAP_FORWARD:-yes}
